        ...
        <form action="{{ route('siswa.update', $siswa->id_siswa) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="kelas" id="kelas" class="form-control" required>
                    ...
                    @foreach($kelasList as $kelas)
                        <option
                            value="{{ $kelas }}" {{ $siswa->kelas == $kelas ? 'selected' : '' }}>{{ $kelas }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="tempat_lahir" id="editTempatLahir"
                       value="{{ old('tempat_lahir', $siswa->tempat_lahir) }}" class="form-control" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_ayah" id="editNamaAyah" value="{{ old('nama_ayah', $siswa->nama_ayah) }}"
                       class="form-control" required>
            </div>

            <div class="form-group">
                <label for="ibu_siswa">Nama Ibu</label>
                <input type="text" name="nama_ibu" id="editNamaIbu" value="{{ old('nama_ibu', $siswa->nama_ibu) }}"
                       class="form-control" required>
            </div>

            <div class="form-group">
                <label for="alamat_siswa">Alamat Siswa</label>
                <input type="text" name="alamat" id="editAlamat" value="{{ old('alamat', $siswa->alamat) }}"
                       class="form-control" required>
            </div>

            <div class="form-group">
                <label for="nohp_siswa">Nomor Wali/Orang Tua</label>
                <input type="text" name="nohp_ortu" id="editNohpOrtu" value="{{ old('nohp_ortu', $siswa->nohp_ortu) }}"
                       class="form-control" required>
            </div>
